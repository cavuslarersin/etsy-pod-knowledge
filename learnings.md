...
- **Shipping-price visibility penalty (US domestic)**: listings with a shipping price above $6 see reduced search visibility. Action item: check every connected shop's shipping profiles — a $7.29 "Standard" tier is above this threshold and may be actively hurting visibility; consider a sub-$6 tier or folding shipping cost into item price with a cheaper nominal shipping option.
